...
const FAQModal = ({ modalState, toggleModal, editDocData }) => {
  ...
  return (
    <div
      className={`fixed w-full overflow-auto z-1 h-full  backdrop-blur-sm top-0 z-1 right-0 justify-center items-center ${
      ...
      {modalState && (
        <form
          ...
          className="z-10 w-[45rem] overflow-y-auto overflow-x-hidden h-[42rem] flex flex-col justify-start items-center p-2 bg-blue-600 rounded-md gap-[2rem] py-5 border-2 border-gray-300">
